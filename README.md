Welcome to a small but growing set of workshops and briefings around the use of R language and RStudio within the IBM Cloud environment, using Watson Studio.
